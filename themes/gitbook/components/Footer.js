...
const Footer = ({ siteInfo }) => {
  ...
  return (
        ...
        >
            ...
            <div className='text-xs font-serif'>Powered By <a href='https://github.com/tr1gv0n/NotionNext' className='underline text-gray-500 dark:text-gray-300'>NotionNext {siteConfig('VERSION')}</a></div>
