...
const BLOG = {
  // Important page_id！！！
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'aa43ab7a63984fd09336378fd6e78094',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'tr1gv0n', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blg.milkcoff.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'tr1g 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tr1gv0n
